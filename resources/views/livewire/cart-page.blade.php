    <div wire:poll.2s class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <div class="flex flex-col md:flex-row gap-4">
                <div class="md:w-3/4">
                    <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
                        <table class="w-full">
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="5" class="text-right font-bold text-xl py-4">
                                        Total: {{ Number::currency($grand_total, 'USD') }}
                                    </td>
                                </tr>
                            </tfoot>
                ...
                <div class="md:w-1/4">
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        @if ($cart_items)
                            <a href="/checkout" class="bg-blue-500 block text-white py-2 px-4 rounded-lg mt-4 w-full">
                                Checkout
                            </a>
                        @endif
                    </div>
