            ...
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{ url('storage', $product->image[0]) }}' }">
                    <div class="sticky top-0 z-50">
                        <!-- الصورة الرئيسية -->
                        <div class="relative mb-6 lg:mb-10 w-full" style="height: 500px;">
                            <img x-bind:src="mainImage" alt="{{ $product->name }}"
                                class="object-cover w-full h-full rounded-md">
                        </div>

                        <!-- الصور الثانوية -->
                        <div class="flex flex-wrap hidden md:flex gap-2">
                            @foreach ($product->image as $image)
                                <div class="w-1/2 sm:w-1/4">
                                    <img src="{{ url('storage', $image) }}" alt="{{ $product->name }}"
                                        class="w-full h-32 object-cover rounded cursor-pointer border hover:border-blue-500"
                ...
                <div class="w-full px-4 md:w-1/2">
                    <div class="lg:pl-20">
                        <div class="mb-8 [&>ul]:list-disc [&>ul>li]:ml-4">
