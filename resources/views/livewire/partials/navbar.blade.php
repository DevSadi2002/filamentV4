            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a wire:navigate
                            class="font-medium {{ request()->is('/') ? 'text-blue-600 dark:text-blue-600 hover:text-blue-400 ' : 'text-gray-500 dark:text-blue-600 hover:text-blue-400' }}hover:text-gray-400 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                        ...
                        <a wire:navigate
                            class="font-medium {{ request()->is('cart') ? 'text-blue-600' : 'text-gray-500' }} hover:text-gray-400 flex items-center py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/cart">
                            ...
                            <span
                                class="py-0.5 px-1.5 rounded-full text-xs font-medium bg-blue-50 border border-blue-200 text-blue-600">{{ $total_count }}
                            </span>
                        </a>

                        @if (auth()->check())
                            <div class="hidden pt-3 md:pt-0">
                                <a wire:navigate
                        ...
                        @auth
                            <div
                                class="hs-dropdown relative [--strategy:absolute] [--trigger:click] md:[--trigger:hover] md:py-4">
                                <button type="button"
                                ...
                                <div
                                    ...
                                    <form method="POST" action="{{ route('logout') }}" class="w-full">
                                        @csrf
                                        <button type="submit"
                                            class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 w-full text-left">
