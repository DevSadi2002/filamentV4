        ...
        return $schema
            ->components([
                Group::make()->schema([
                        ...
                        ->schema([
                            Repeater::make('items')->relationship('items')->schema([
                                select::make('product_id')
                                    ->label('Product')->reactive()->relationship('product', 'name')->searchable()->preload()->distinct()->reactive()->disableOptionsWhenSelectedInSiblingRepeaterItems()
                    ...
                    Hidden::make('grand_total')->default(0)->dehydrated()->columnSpanFull(),
                ])->columnSpanFull(),
            ]);
    }
}
